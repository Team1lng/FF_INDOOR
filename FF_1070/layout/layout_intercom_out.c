...
static void intercom_out_back_btn_up(lv_obj_t *obj)
{
...
{
	lv_obj_t *sound_btn = lv_obj_get_child_form_id(lv_scr_act(), INTERCOM_OUT_SOUND_BTN_OBJ_ID);
	if (sound_btn)
	{
...
static void vol_slider_event_cb(lv_obj_t *slider, lv_event_t event)
{
	if (event == LV_EVENT_VALUE_CHANGED)
	{
		...
		// 更新音量标签
		lv_obj_t *vol_label = lv_obj_get_child_form_id(lv_scr_act(), INTERCOM_OUT_VOL_LABEL_ID);
		if (vol_label)
		{
		...
		lv_obj_t *slider_indicator = lv_obj_get_child_form_id(lv_scr_act(), INTERCOM_OUT_VOL_SLIDER_INDICATOR_ID);
		if (slider_indicator)
		{
...
static void intercom_out_volume_slider_create(lv_obj_t *parent)
{
	...
	lv_obj_set_id(slider_bg, INTERCOM_OUT_VOL_SLIDER_BG_ID);
	...
	lv_obj_set_id(slider_indicator, INTERCOM_OUT_VOL_SLIDER_INDICATOR_ID);
	...
	lv_obj_set_id(vol_label, INTERCOM_OUT_VOL_LABEL_ID);
...
{
	lv_obj_t *slider_bg = lv_obj_get_child_form_id(lv_scr_act(), INTERCOM_OUT_VOL_SLIDER_BG_ID);
	lv_obj_t *slider_indicator = lv_obj_get_child_form_id(lv_scr_act(), INTERCOM_OUT_VOL_SLIDER_INDICATOR_ID);
	lv_obj_t *slider = lv_obj_get_child_form_id(lv_scr_act(), INTERCOM_OUT_VOL_SLIDER_ID);
	lv_obj_t *vol_label = lv_obj_get_child_form_id(lv_scr_act(), INTERCOM_OUT_VOL_LABEL_ID);
...
static void LAYOUT_ENTER_FUNC(intercom_out)
{
	...
	intercom_out_back_btn_create(parent);	   // 返回按钮
	intercom_out_sound_btn_create(parent);	   // 声音按钮
	intercom_out_text_icon_create(parent);	   // 挂断按钮
	intercom_out_volume_slider_create(parent); // 音量滑块
